...
RESUME
------
This scripts build a binary digiKam installer for Windows under Linux using cross-compiler
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/haswell/libdigikamcore.so.6.2.0
/usr/lib64/haswell/libdigikamdatabase.so.6.2.0
/usr/lib64/haswell/libdigikamgui.so.6.2.0
/usr/lib64/libdigikamcore.so.6.2.0
/usr/lib64/libdigikamdatabase.so.6.2.0
/usr/lib64/libdigikamgui.so.6.2.0
